...
{
    public class RemoveUnavailableContentCommandHandler
        : IRequestHandler<RemoveUnavailableContentCommand, Result<bool>>
    {
        private readonly IContentPartyEstimationRoomRepository contentPartyEstimationRoomRepository;

        public RemoveUnavailableContentCommandHandler(
        ...
        public async Task<Result<bool>> Handle(
            RemoveUnavailableContentCommand request,
        ...
        )
        {
            ...
            await contentPartyEstimationRoomRepository.UnitOfWork.SaveChangesAsync(
                cancellationToken
            );
