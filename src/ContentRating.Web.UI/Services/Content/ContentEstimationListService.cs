...
namespace ContentRating.Web.UI.Services.Content
{
    ...
    public class ContentEstimationListService : IContentEstimationListService
    {
        ...
        public ContentEstimationListService(
            HttpClient httpClient,
            ILogger<ContentEstimationListService> logger
        )
        {
        ...
        public async Task<bool> CreateRoomAsync(string roomName)
        {
            ...
            catch (Exception ex)
            {
                _logger.LogError(
                    ex,
                    "Ошибка при создании комнаты редактора контента с именем {RoomName}",
                    roomName
                );
                return false;
            }
        ...
        public async Task<bool> DeleteRoomAsync(Guid roomId)
        {
            ...
            catch (Exception ex)
            {
                _logger.LogError(
                    ex,
                    "Ошибка при удалении комнаты редактора контента {RoomId}",
                    roomId
                );
                return false;
            }
        ...
        )
        {
            ...
            catch (Exception ex)
            {
                _logger.LogError(
                    ex,
                    "Ошибка при обновлении контента {ContentId} в комнате {RoomId}",
                    contentId,
                    roomId
                );
                return false;
        ...
        public async Task<bool> DeleteContentAsync(Guid roomId, Guid contentId)
        {
            ...
            catch (Exception ex)
            {
                _logger.LogError(
                    ex,
                    "Ошибка при удалении контента {ContentId} из комнаты {RoomId}",
                    contentId,
                    roomId
                );
                return false;
        ...
        public async Task<bool> KickEditorAsync(Guid roomId, Guid editorId)
        {
            ...
            catch (Exception ex)
            {
                _logger.LogError(
                    ex,
                    "Ошибка при исключении редактора {EditorId} из комнаты {RoomId}",
                    editorId,
                    roomId
                );
                return false;
