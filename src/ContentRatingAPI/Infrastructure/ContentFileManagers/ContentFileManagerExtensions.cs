...
namespace ContentRatingAPI.Infrastructure.ContentFileManagers
{
    public static class ContentFileManagerExtensions
    {
        ...
        {
            builder.Services.Configure<ContentFileOptions>(
                builder.Configuration.GetSection("ContentFile")
            );
            builder.Services.Configure<FFMPEGOptions>(
                builder.Configuration.GetSection("FFMEPGOptions")
            );
            ...
            builder.Services.AddScoped<GstreamerVideoSaver>();
            ...
            builder.Services.AddScoped<IContentFileManager, ContentFileMongoManager>(s =>
            {
                ...
                var videoSaver = s.GetRequiredService<GstreamerVideoSaver>();
