...
namespace ContentRating.Domain.Tests.ContentPartyEstimationRoom
{
    public class ContentPartyEstimationRoomTests
    {
        ...
        public void InviteUser_ByAdmin_AddedUserInvitedEvent()
        {
            ...
            var accessControl = ContentPartyEstimationRoom.Create(Guid.NewGuid(), creator);
        ...
        public void InviteUser_ForbiddenInviteRole_ThrowForbiddenRoomOperationException(RoleType forbiddenInviteRole)
        {
            ...
            var accessControl = ContentPartyEstimationRoom.Create(Guid.NewGuid(), creator, [inviteInitiator]);
        ...
        public void KickUser_ByAdmin_AddUserKickedEvent()
        {
            ...
            var accessControl = ContentPartyEstimationRoom.Create(Guid.NewGuid(), creator, [userForKick]);
        ...
        public void KickUser_ForbiddenKickRole_ThrowForbiddenRoomOperationException(RoleType forbiddenInviteRole)
        {
            ...
            var accessControl = ContentPartyEstimationRoom.Create(Guid.NewGuid(), creator, [kickInitiator, kickTarget]);
        ...
        public void RequestUserAccessInformation_DefaultUser_LimitedAccess()
        {
            ...
            var accessControl = ContentPartyEstimationRoom.Create(Guid.NewGuid(), creator, [defaultUser]);
